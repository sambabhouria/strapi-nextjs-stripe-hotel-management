...
const Home = () => {
  ...
  const getsurvey = async (value) => {
    console.log("🚀 ~ file: index.js:21 ~ getsurvey ~ value:", value)
    let Tasks = value &&  await axios.get("http://localhost:1337/api/rooms/" + Number(value));
    console.log("🚀 ~ file: index.js:23 ~ getsurvey ~ Tasks:", Tasks)
    console.log("🚀 ~ file: index.js:23 ~ getsurvey ~ Tasks:", Tasks)
